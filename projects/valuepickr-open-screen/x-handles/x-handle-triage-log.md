...
## 2026-09-07
- Scan (browser): 5 handles [@CongruenceA @bharatbetpf @nareshbahrain @Rahul_Invest @Rishikesh_ADX], 75 tweets total (CongruenceA 17, bharatbetpf 12, nareshbahrain 17, Rahul_Invest 17, Rishikesh_ADX 17). X live-search feed stagnated far short of the 183-day target on every handle — windows returned: CongruenceA back to 2026-08-18, bharatbetpf back to 2026-08-31, nareshbahrain back to 2026-09-03, Rahul_Invest back to 2026-08-20, Rishikesh_ADX only the single 2026-09-05 thread. Not the 150-post cap — search result limiting / early stagnation.
- Dossiers written: CongruenceA, bharatbetpf, nareshbahrain, Rahul_Invest, Rishikesh_ADX.
- New names seeded (external-lead, x_untrusted): beezaasan-explotech (@Rahul_Invest, disclosed rec Rs225 +85% to ATH), jindal-saw (@nareshbahrain, retrospective valuation-zone win Rs153->Rs319) (2/15 cap).
- Overflow (in dossier, not seeded): none.
- Existing-name re-look flags (→ existing-name-sightings.md): none. CongruenceA's Entero Healthcare thread is a bear/passed view (not a bull thesis) so does not meet the re-look bar; HDFC Bank sighting is mega-cap mild-positive.
- Watch-only names recorded: 31 (CongruenceA: Redington. nareshbahrain: Engineers India. Rahul_Invest: National Fittings + 3 unresolved anonymised promoter-buying teasers. Rishikesh_ADX: 25-name technical breakout watchlist — Macpower CNC, GHCL Textiles, Bosch, Sundram Fasteners, West Coast Paper, Bodal Chem, Anthem Bio, Caplin Point, IFCI, New India Assurance, etc.).
- Notes: Rishikesh_ADX is a pure chartist (breakout lists, explicit no-recommendation disclaimer) — will rarely seed; down-weight. bharatbetpf showed only macro/strategy content in the shallow window — "no names" conclusion is window-limited, worth an Apify re-scrape on the ranking pass. nareshbahrain & Rahul_Invest are high-cadence and name-withholding respectively; deeper scrapes would likely surface more.
- Backlog: 68/103 remaining.

## 2026-09-07
- Scan (browser): 5 handles [@rohitchauhan @UditSharma_IH @MashraniVivek @AdityaKhemka5 @Amit_Jeswani1], 212 tweets total (rohitchauhan 56, UditSharma_IH 0, MashraniVivek 134, AdityaKhemka5 14, Amit_Jeswani1 8). Windows: rohitchauhan full (2026-03-09->2026-09-05); MashraniVivek TRUNCATED at the ~150-post deep-window cap (only 2026-07-18->2026-09-06 scanned); AdityaKhemka5 full (2026-03-09->2026-06-27, nothing after June); Amit_Jeswani1 near-full (2026-03-23->2026-07-22); UditSharma_IH genuine empty-state (0 posts in window).
- Dossiers written: rohitchauhan, UditSharma_IH, MashraniVivek, AdityaKhemka5, Amit_Jeswani1.
- New names seeded (external-lead, x_untrusted): none (0/15 cap).
- Overflow (in dossier, not seeded): none.
- Existing-name re-look flags (→ existing-name-sightings.md): none. MashraniVivek's TD Power Systems (bull, high) is already researched Medium-High / analyzed 2026-08-22 — doesn't meet the re-look bar; HDFC Bank mention was a neutral video-title question, not a high/very-high thesis.
- Watch-only names recorded: 0.
- Notes: Two of the five (rohitchauhan, UditSharma_IH) do not name stocks on X — rohitchauhan reserves names for his paid advisory ("refuses" pattern), UditSharma_IH is dormant since Sep 2024. AdityaKhemka5 (pharma CIO) and Amit_Jeswani1 (Stallion) both name stocks off-platform (podcast / TV) but posted near-zero stock content on X this window. MashraniVivek is high-cadence but heavily community-marketing; its 2 calls (TD Power, HDFC Bank) are both existing names. Zero seed yield this batch — all five are weak X call-sources.
- Backlog: 63/103 remaining.

## 2026-09-08
- Scan (browser): 5 handles [@nbalajiv @NeilBahal @niveshaay @SamitVartak @vbomkara], 64 tweets total (nbalajiv 17, NeilBahal 17, niveshaay 9, SamitVartak 11, vbomkara 10). Windows: nbalajiv back to 2026-04-12, NeilBahal back to 2026-03-23, SamitVartak back to 2026-03-23 (no tweets after 2026-06-29) — near-complete given their low cadence. niveshaay and vbomkara are high-cadence but X live-search returned ONLY the last ~5–6 days (niveshaay 2026-09-03..09-07; vbomkara 2026-09-02..09-08) — search result limiting, not the 150-post cap; both need a later run / Apify pass for Mar–Aug.
- Dossiers written: nbalajiv, NeilBahal, niveshaay, SamitVartak, vbomkara.
- New names seeded (external-lead, x_untrusted): none (0/15 cap).
- Overflow (in dossier, not seeded): none.
- Existing-name re-look flags (→ existing-name-sightings.md): none. All 3 conviction mentions are existing, recently-analyzed entries: niveshaay→ESDS Software (bull/high, disclosed PMS holding; researched Medium, analyzed 2026-09-04) + Ather Energy (bull/medium; researched Medium, analyzed 2026-08-26); vbomkara→Sansera Engineering (bull/high, disclosed "invested and advised" + CLSA TP ~Rs5000; researched Medium, source trusted-x, analyzed 2026-08-30). None meets the excluded / Low / >75d re-look bar.
- Watch-only names recorded: 0.
- Notes: nbalajiv, NeilBahal, SamitVartak name no India-listed single stocks on X in the window (macro / index / process content only; SageOne & NAFA reserve names for memos/columns; NeilBahal's X account carries ~zero stock signal). niveshaay & vbomkara do disclose names but the retrievable slice was too short to characterise them. Zero seed yield this batch.
- Backlog: 58/103 remaining.

## 2026-09-09
- Scan (browser FAILED -> apify-fallback): browser path (claude-in-chrome) throttled this run — X live-search + profile infinite-scroll capped at ~5-6 posts across every URL/reload, no error banner; switched all 5 handles to Apify. First Apify `searchTerms` array call returned only KaitoEasyAPI mock; retried per-handle with `twitterContent` single-query (runIds BK4MVKdljFGhTDDBQ mock, then 5cGKEuyeaLY6LAG3k / AF1pTzEh5MgON91W3 / 0XJmzZnEAn2JDFdhd / (SB large-file) / Sop5gZ83NgBYvhZT2 — all real). 5 handles [@virajmehta16 @BeatTheStreet10 @thenamanchandak @Sanjay__Bakshi @MarcellusInvest], 341 real tweets total (viraj 65, BTS 120, naman 1, bakshi 97, marcellus 58).
- Dossiers written: virajmehta16, BeatTheStreet10, thenamanchandak, Sanjay__Bakshi, MarcellusInvest.
- New names seeded (external-lead, x_untrusted): 27 total, no cap (all from @BeatTheStreet10). BEAR: rajesh-exports, eraaya-life-spaces. BULL high: susan-electricals-india, ashutosh-fibre, indo-borax, gv-electricals, monolithish, creative-newtech, atharva-polyplast, max-india, oval-projects, shri-ahimsa-naturals, smr-jewels, rajnandini-fashion-india. BULL medium: nelco, lloyds-engineering-works, cryogenic-ogs, sacheerome, e-to-e-transportation-infrastructure, exato-technologies, purple-united-sales, millworks-technologies, lloyds-metal-energy, suba-hotels, sar-televenture, recode-studios, sotefin-bharat.
- NOTE: the 15-seed/run cap was removed from SKILL.md Step 4 this run per user instruction ("don't keep any limit of the external-lead or x_untrusted"). The 12 names previously logged as overflow were seeded in a follow-up pass; do not reinstate the cap.
- Not seeded (dossier note only, un-actionable): Jaiprakash Associates (delisted, equity extinguished), Osia Hyper Retail (filed insolvency), Space International Ltd (pump-warning, fuzzy identity).
- Existing-name re-look flags (-> existing-name-sightings.md): mazagon-dock-shipbuilders (@BeatTheStreet10 high bull, currently researched/Low). Other existing bull sightings recorded in BTS dossier only (recent last_analyzed, conviction not weak enough): msafe-equipments, l-t-elevators, prizor-viztech, vivid-electromech, workmates-core2cloud, ather-energy, dhoot-transmission, piccadily-agro, cartrade-tech, borosil-renewables, jeena-sikho, waaree-energies, heg. Bearish on existing: osel-devices, vikram-solar.
- Watch-only names recorded: 15 (BTS 12 incl HFCL, Sterlite Tech, KSG International, KRN Heat Exchanger, TANFAC, Jio Financial, Lenskart, Space International, JP Associates, Osia Hyper, SISCOL, Deccan Gold; Sanjay__Bakshi 3 — Shriram Finance, IRFC, DMart, all teaching illustrations).
- Notes: @Sanjay__Bakshi disclaimer_pattern=refuses ("None. No view!" / "I won't be naming the companies here" / "Stocks mentioned here are not being recommended") — essentially never seedable. @MarcellusInvest is a pure content-marketing channel, names no holdings. @thenamanchandak dormant on this handle (1 post, no stock content) despite cluster-adjacent SOIC RA tag. @virajmehta16 tagged "names openly" but this 183-day slice was all cricket/chess/politics + market philosophy, nothing nameable (one unresolvable bearish "TN group / rubber-stamp board / pref allotment at inflated valuation" remark, note only).
- Backlog: 53/103 remaining.

## 2026-09-12
- Scan (browser): 5 handles [@thesanjaydutt @1shankarsharma @VijayKedia1 @MunkThePunk @DesaiAmeet], 50 tweets total (thesanjaydutt: 11; 1shankarsharma: 10, search stalled after 3-day span — likely undercounts; VijayKedia1: 9; MunkThePunk: 10; DesaiAmeet: 10).
- Dossiers written: thesanjaydutt, 1shankarsharma, VijayKedia1, MunkThePunk, DesaiAmeet.
- New names seeded (external-lead, x_untrusted): none (Quality Power and TD Power Systems both already in registry, not re-seeded).
- Not seeded (dossier note only — WATCH-only / unresolvable / delisted-or-insolvent): Tirupati Forge, Atlanta Electricals, Hitachi Energy India (all watch-only, MunkThePunk).
- Existing-name re-look flags (→ existing-name-sightings.md): none (Quality Power last analyzed 2026-08-24/conviction Medium; TD Power last analyzed 2026-08-22/conviction Medium-High — both recent, neither below the Low/Low-Medium or 75-day threshold).
- Watch-only names recorded: 3.
- Notes: thesanjaydutt, 1shankarsharma, VijayKedia1 — no India-listed single-stock mentions at all in window (macro/banter/personal content only).
- Backlog: 48/103 remaining.

## 2026-09-13 — Bulk backlog clear (48 handles, user-directed parallel subagent sweep)
- User asked to clear the entire remaining deep-pass backlog in one sweep rather than the usual 5/run cadence, using 8 parallel subagents (6 handles each) and to check for any newer scrape connector beyond Browser/Apify. No dedicated X-scraper connector exists in the registry; `twitter-knowledge-base` MCP is the user's own personal bookmark KB (521 entries, PM/career/travel/investing topics) — not applicable here. Browser (Chrome, logged-in) stayed primary, Apify fallback, exactly as designed; the shared Chrome tab group across 8 concurrent workers did get rate-limited/overloaded on several handles, which triggered clean per-handle Apify fallback (no data loss, all noted in dossiers). One subagent (batch 7) hit a platform session-limit error mid-run and was relaunched from scratch after reset; a second (batch 6) turned out to have already finished all 6 dossiers before its rate-limit failure, so no rework was needed there.
- 48 handles scraped: geordiejob, ashwinidamani, sudhir_bheda, chetanshahrare, ChintanParikh10, DEBU_NEOGI, 13gaurdevesh, nathanit2014, Goyal4Gagan, gaurang_19, rishithegreat41, JakeraChoudhury, mishika_chamria, MindofManish, mayank66333, AnyBodyCanFly, ParthaAwe, Prashanth_Krish, PRATIKBULANI555, pgodhani, StocksResearch, Priyaanshu06, rajuidesai, r_laroia, sab_maya_hai__, SureshKBN, Disciplined_Inv, RupakRoyC, investor_vineet, lahoti_yash, ravi_eee11, utsav1711, saditya10p, Capeeyush91, SanaSecurities, rdkriplani, ChanderBhatia01, trivedi_gautam, jain_satwik_, VineetGala, jeevanpatwa, AimInvestments, aditya_kondawar, bastionresearch, mohan_koushik1, MarketSmithIND, nid_rockz, mystockedge.
- Totals: ~4,868 tweets scanned, 478 conviction calls extracted, 258 watch-only names recorded. 5 handles came back genuinely empty (gaurang_19, pgodhani, utsav1711, trivedi_gautam, jain_satwik_ — confirmed via page-text checks, not scrape failures).
- Dossiers written: all 48, under `x-handles/dossiers/<handle>.md`.
- New names seeded (external-lead, x_untrusted): **204** — full list in `state.json` (filter `source:"external-lead" AND x_first_seen_date:"2026-09-13"`) or `/tmp/seeded_slugs_list.txt` from this run. Consolidation deduped 234 raw new-name hits down to 204 unique companies (merged same-company slug variants e.g. ifci/ifci-ltd, trishakti/trishakti-industries, tata-motors/tata-motors-commercial-vehicles; corrected 8 subagent slug-resolution errors — 6 falsely marked "new" that were already in the registry, 2 falsely marked "existing" that were genuinely new: Ashapura Minechem, Valor Estates). Heaviest contributors: rajuidesai (26), SanaSecurities (24), rdkriplani (21), saditya10p (18), JakeraChoudhury (17), PRATIKBULANI555 (16), ChintanParikh10 (13). This is a large one-off batch from clearing 48 handles at once (vs. the usual 5/run trickle) — vpscreen-scan's tier-4.5 fast `neither` exit is the downstream quality gate, per design.
- Not seeded (dossier note only — WATCH-only / unresolvable / delisted-or-insolvent): 258 watch-only names across all handles (see individual dossiers).
- Existing-name re-look flags (→ existing-name-sightings.md): 56 (stale/Low/Low-Medium/excluded existing entries given a fresh high/very-high bull thesis by a triage handle) — includes creative-newtech, unicommerce-esolutions, parag-milk-foods, raymond, cyient, laurus-labs, azad-engineering, hdfc-bank, man-industries, embassy-developments, and 46 more.
- Watch-only names recorded: 258 (see per-handle dossiers).
- Notes: 5 confirmed-empty handles (see above). rategain, ifci, trishakti mention-merges resolved via manual slug reconciliation.
- Backlog: 0/103 remaining. **SCOPE COMPLETE — all 103 deep-pass handles now triaged.** This task can be deleted; vpscreen-audit will flag it (see TRIAGE_STATUS.md). x-handle-ranking continues as the steady state.
